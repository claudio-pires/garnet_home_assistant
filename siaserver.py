...
class SIAUDPServer():
    ...
    def __init__(self):
        ...
        SIAUDPServer.t = threading.Thread(target=SIAUDPServer.__messageserver_thread)
        SIAUDPServer.t.start()
        timeout = 0
                ...
                if(data.valid):                                                             # Valid packet
                    ...
                    if(data.account in SIAUDPServer.subscribers):
                        if(data.token != "ADM-CID"):
                            SIAUDPServer.subscribers[data.account](keepalive = True)
                        else:
                            data.parseADMCID()
                            ...
                            if(data.eventcode == 602):
                                SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (TEST PERIODICO), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (BYPASS), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (GROUP BYPASS), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ARMADO PRESENTE), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ARMADO AUSENTE), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ARMADO ALARMADO), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ARMADO x TECLADO), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ALARMA ZONA), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                                ...
                                if(data.qualifier == 1):
                                    ...
                                    SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + " (ALARMA), qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                            else:
                                SIAUDPServer.subscribers[data.account](message = "El panel esta notificando eventcode: " + str(data.eventcode) + ", qualifier: " + str(data.qualifier) + ", particion: " + str(data.partition) + ", zona: " + str(data.zone) + " con optionalExtendedData: " + data.optionalExtendedData + " - " + data.timestamp)
                    else:
